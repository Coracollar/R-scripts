...
imprintedgenes1<-read.table(file="/data/cephfs/punim1048/Methylation_Analysis/genesmethylation/imprintedgenes1.txt", header=T)
...
paternalexpresedgenes1<-read.table(file="/data/cephfs/punim1048/Methylation_Analysis/genesmethylation/paternalexpressedgenes1.txt", header=T)
maternalexpresedgenes1<-read.table(file="/data/cephfs/punim1048/Methylation_Analysis/genesmethylation/maternalexpresedgenes1.txt", header=T)
